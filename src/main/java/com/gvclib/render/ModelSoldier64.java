...
public class ModelSoldier64 extends ModelBiped
{
    public ModelSoldier64()
    {
        this(0.0F, false);
    }

    public ModelSoldier64(float modelSize, boolean p_i1168_2_)
    {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        if (entityIn instanceof EntityGVCLivingBase && entityIn != null) {
			...
			/*if(Loader.isModLoaded("techguns")) {
				if(!en.getItemStackFromSlot(EntityEquipmentSlot.MAINHAND).isEmpty()
					&& en.getItemStackFromSlot(EntityEquipmentSlot.MAINHAND).getItem() instanceof GenericGun){
					guntask = true;
				}
        	...
        	if(!en.getItemStackFromSlot(EntityEquipmentSlot.MAINHAND).isEmpty()
        			&& en.getItemStackFromSlot(EntityEquipmentSlot.MAINHAND).getItem() instanceof IGun_Sword){
        		guntask = false;
        	}
        	if(en.getRemain_L() <= 0){
        		isReload = true;
        ...
        {
        	 this.bipedRightArm.rotateAngleX = this.bipedRightArm.rotateAngleX * 0.5F - 0.4424779F;
         //    this.bipedRightArm.rotateAngleY = -0.5235988F;
        	 this.bipedRightArm.rotateAngleY = 0;
             
             this.bipedLeftArm.rotateAngleX = this.bipedLeftArm.rotateAngleX * 0.5F - 0.4424779F;
        ...
        if(isCombat && isReload)
        {
        	this.bipedRightArm.rotateAngleX = this.bipedRightArm.rotateAngleX * 0.5F - 0.4424779F +0.3F;
        }
